...
@section('sidebar')
    ...
    <div class="slider">
        ...
        <ul class="slides">
            <li>
                <img src="before/img/slide1.jpg" alt="">
            ...
            <li>
                <img src="before/img/slide2.jpg" alt="">
                <div class="caption slider-content center-align">
            ...
            <li>
                <img src="before/img/slide3.jpg" alt="">
                <div class="caption slider-content center-align">
                    <h2>FASHION SHOP</h2>
                    <h4>Lorem ipsum dolor sit amet.</h4>
                    <a href="" class="btn button-default">SHOP NOW</a>
    ...
    <div class="section product">
        <div class="container">
            ...
            <div class="row">
                <div class="col s6">
                    <div class="content">
                        <img src="before/img/product-new1.png" alt="">
                ...
                <div class="col s6">
                    <div class="content">
                        <img src="before/img/product-new2.png" alt="">
                        <h6><a href="">Fashion Men's</a></h6>
                        <div class="price">
                            $20 <span>$28</span>
                        </div>
            ...
            <div class="row margin-bottom">
                <div class="col s6">
                    <div class="content">
                        <img src="before/img/product-new3.png" alt="">
                        <h6><a href="">Fashion Men's</a></h6>
                        <div class="price">
                            $20 <span>$28</span>
                        </div>
                ...
                <div class="col s6">
                    <div class="content">
                        <img src="before/img/product-new4.png" alt="">
                        <h6><a href="">Fashion Men's</a></h6>
                        <div class="price">
                            $20 <span>$28</span>
                        </div>
    ...
    <div class="promo section">
        <div class="container">
            <div class="content">
                ...
                <a href="/productList"><button class="btn button-default">SHOP NOW</button></a>
            </div>
        </div>
    </div>
    <!-- end promo -->
