...
@section('sidebar')
	...
	<div class="pages section">
		<div class="container">
			...
			<div class="login">
				<div class="row">
					<form class="col s12" method="post" action="/login_do">
						@csrf
						<div class="input-field">
							<input type="text" class="validate" placeholder="USERNAME" name="name">
						</div>
						<div class="input-field">
							<input type="password" class="validate" placeholder="PASSWORD" name="pwd">
						</div>
