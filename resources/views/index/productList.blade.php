...
@section('sidebar')
		...
		<div class="container">
			<div class="pages-head">
				...
				<form action="/productList" method="post">
					@csrf
					<input type="text" name="goods_name"><input type="submit" value="搜索">
				</form>
			...
			<div class="row">
				...
				<div class="col s6">
					<div class="content">
						...
						<h6><a href="/shopSingle?id={{$v->id}}">{{$v->goods_name}}</a></h6>
						<div class="price">
	...
	<!-- end loader -->
<script type="text/javascript" src="/before/js/jquery-3.3.1.js"></script>
<script type="text/javascript" src="/before/js/xxoo.js"></script>
@endsection
